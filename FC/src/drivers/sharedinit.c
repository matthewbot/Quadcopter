...
void sharedinit_init() {
	...
	nvic_set_priority(EXTI9_5_IRQn, PRI_LOW); // micromag drdy line. will trigger some floating calculations every three interrupts
	...
	// Used to time ppm and US signals, as well as check timeouts on micromag and vexrc
	timer_setup(2, 1000 / TIMER2_TPMS, TIMER2_MAXVAL, TIMER_DIRECTION_UP); 
